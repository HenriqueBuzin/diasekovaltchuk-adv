ERROR_MESSAGES = {
    ...
    "email_domain_unavailable": "O domínio deste e-mail não existe ou não está preparado para receber mensagens.",
    "frontend_missing": "Frontend build not found. Run npm run build.",
    "honeypot": "Não foi possível enviar a mensagem. Tente novamente.",
    "invalid_secret_file": "Não foi possível carregar o arquivo de segredos da aplicação.",
    ...
    "unsupported_captcha_provider": "Provider de CAPTCHA não suportado: {name}",
